...
interface SignedZoneCaptainInterface {
     ...
     */
    function updateZoneSigner(address zone, address signer, bool active) external;
     ...
     */
    function updateZoneAPIEndpoint(address zone, string calldata newApiEndpoint) external;
     ...
     */
    function updateZoneDocumentationURI(address zone, string calldata newDocumentationURI) external;
     ...
     */
    function transferZoneOwnership(address zone, address newPotentialOwner) external;
     ...
     */
    function rotateSigners(address zone, address signerToRemove, address signerToAdd) external;
