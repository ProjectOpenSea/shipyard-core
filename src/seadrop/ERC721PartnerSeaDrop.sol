...
contract ERC721PartnerSeaDrop is ERC721SeaDrop, TwoStepAdministered {
     ...
     */
    function mintSeaDrop(address minter, uint256 quantity) external virtual override {
        ...
        onlyOwnerOrAdministrator
    {
        ...
        PublicDrop memory retrieved = ISeaDrop(seaDropImpl).getPublicDrop(address(this));
        ...
        if (msg.sender != administrator) {
            ...
            retrieved.maxTotalMintableByWallet = maxTotalMintableByWallet > 0 ? maxTotalMintableByWallet : 1;
        ...
        onlyOwnerOrAdministrator
    {
        ...
        TokenGatedDropStage memory retrieved = ISeaDrop(seaDropImpl).getTokenGatedDrop(address(this), allowedNftToken);
    ...
    function updateSignedMintValidationParams(
        ...
        SignedMintValidationParams memory retrieved =
            ISeaDrop(seaDropImpl).getSignedMintValidationParams(address(this), signer);
        ...
        if (msg.sender != administrator) {
            ...
            // (maxTotalMintableByWallet > 0) and set
            // feeBps/restrictFeeRecipients.
            uint24 maxMaxTotalMintableByWallet = retrieved.maxMaxTotalMintableByWallet;
            retrieved.maxMaxTotalMintableByWallet = maxMaxTotalMintableByWallet > 0 ? maxMaxTotalMintableByWallet : 1;
